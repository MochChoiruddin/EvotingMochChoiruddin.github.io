    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
                ...
                <a class="intro-text">E-VOTING</a> <br> <a class="navbar-brand">SMK YPM 3 TAMN </a>
        ...
        <div class="container">
            <div class="row">
              <div class="col-lg-12">
                  ...
                  <img src="img/selamat.gif" alt="" width="303" height="174">
                        <span class="name">E-voting</span>
                       
                    <p class="skills"><strong>Terimakasih Anda Berhasil Memilih :)</strong></p>
                        <p class="skills">
                          <a href="index.php"><input name="Selesai" type="submit" class="list-group-item-warning" id="Selesai" value="Selesai"></a>
                        </p>
<p class="skills">&nbsp;</p>
                  </div>
          </div>
  ...
  <footer class="text-center">
            ...
            <div class="container">
                <div class="row">
                    <div class="footer-col col-md-4">
                        ...
                        <p>Jl. Raya Ngelom No.86 Taman, Sidoarjo<br>
        ...
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">Copyright &copy; SMK YPM 3 TAMAN| Create by Mohammad Choiruddin 2019</div>
              </div>
            </div>
        </div>
    </footer>
