...
<div id="splash_tour">
  <div id="button_join_tour">
	...
	$result = mysql_query("SELECT * FROM contestant where cont_id='$cont_id'");
...
<table>
	<input type="hidden" name="cont_id" value="<?php echo $cont_id=$_GET['cont_id'] ?>">
	<tr>
	<td>Nama</td>
	<td>:</td>
            ...
            <td width="21%" align="right" valign="top" bgcolor="#E7EAF0" id="body_form"><table width="100%" border="0" cellspacing="0" cellpadding="2">
              ...
              <tr>
                <td align="right" valign="top"><ul id="MenuBar1" class="MenuBarVertical">
                  <li><a href="add_contestant.php"><img src="../images/icon-48-user-add.png" width="21" height="21" /> Input Data Calon Ketua PGRI </a></li>
              ...
              <tr>
                <td align="right" valign="top"><ul id="MenuBar2" class="MenuBarVertical">
                  ...
                  <li><a href="?select=grafik"><img src="../images/chart.png" width="21" height="21" /> Grafik Hasil Sementara </a></li>
				  <li><a href="?select=logout"><img src="../images/key.png" width="21" height="21" />Logout </a></li>
                  </ul></td>
              </tr>
              <tr>
...
<div id="footer"><span style="background:url(image/blue.jpg) repeat
 scroll center top rgb(233, 233, 231);">
  <div id="footer2"><span class="col-lg-12">Copyright &copy; SMA Negeri 1 Taman Sidoarjo| Create by Mohammad Choiruddin 2018</span><br />
  </div>
</span><br />
  <script type="text/javascript"><!--
