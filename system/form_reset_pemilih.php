...
<table class="table table-bordered table-hover"id="daftar" border='1' style="border-collapse:collapse" cellpadding='1' cellspacing='2' align='left' width='85%'>
	...
	<td>Nama</td>
	<td>:</td>
	<td><input type="text" name="password" value="<?php echo $r['password'] ?>" class="ed"></td>
	</tr>
	<tr>
	<td>Perolehan</td>
	<td>:</td>
	<td><select name="status" id="status">
    <option value="<?php echo $status='0' ?>">Reset Pemilih</option>
            </select>
	...
	<tr>
	  <td></td>
	  <td></td>
	  <td><input type="submit" value="Reset" id="button1"></td>
