...
<table class="table table-bordered table-hover"id="daftar" border='1' style="border-collapse:collapse" cellpadding='1' cellspacing='2' align='left' width='85%'>
	...
	<td>Perolehan</td>
	<td>:</td>
	<td><select name="jumlah_suara" id="jumlah_suara">
    <option value="<?php echo $jumlah_suara='0' ?>">Reset Perolehan</option>
            </select>
...
NB.Setelah Reset Perolehan Suara Jangan Lupa Reset Daftar Pemilih Juga!!!
</td>
  </tr>
