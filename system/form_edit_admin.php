...
<body>
	...
	$edit = mysql_query("SELECT * FROM password WHERE id='$_GET[id]'");
...
<table class="table table-bordered table-hover"id="daftar" border='1' style="border-collapse:collapse" cellpadding='1' cellspacing='2' align='left' width='85%'>
	...
	<td>User Name</td>
	<td>:</td>
	<td><input type="text" width="200"  name="username" value="<?php echo $r['username']?>" class="ed"></td>
	</tr>
    <tr>
	<td>Password</td>
	<td>:</td>
	<td><input type="password" width="200" height="20" name="password" value="<?php echo $r['password'] ?>" class="ed"></td>
	</tr>
	...
	<tr>
	  ...
	  | 
	    <a href="form_data_admin.php"><input type="button" class="btn btn-primary" value="Batal" id="button2"></a></td>
