...
<body>
    ...
    <!-- proses Reset data Pemilih -->
    <form action="proses_reset_pemilih.php" method="POST">
    ...
    ?>
    <input  type="hidden" name="matric_no[]" value="<?php echo $id; ?>">
    <tr>
    <td>Nama</td>
    <td>:</td>
    <td><input type="text" name="password" value="<?php echo $address ?>" class="ed"></td>
    </tr>
    <tr>
    <td>Perolehan</td>
    <td>:</td>
    <td><select name="status" id="status">
      <option value="<?php echo $name='0' ?>">Reset Pemilih</option>
              </select>
...
<strong>NB.Setelah Reset Daftar Pemilih Jangan Lupa Reset Perolehan Suara Juga!!!</strong>
                    <ol class="breadcrumb">
                      <li class="active"></li>
                    </ol>
                    </div>
