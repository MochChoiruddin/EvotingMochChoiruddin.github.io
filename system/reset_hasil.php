...
<h1 class="page-header">
                            Reset Perolehan Suara Pemilihan Ketua Osis
                        </h1>
...
<td width="5%" align="center" valign="middle">Perolehan</td>
<td width="3%" align="center" valign="middle">Reset</td>
...
while  ($isi  = mysql_fetch_array($tampilkan_isi_sql))
	...
	$jumlah_suara=$isi['jumlah_suara'];
			...
			echo '<tr class="center">';
									...
									echo '<td <valign="top"><a href="form_reset.php?id_kandidat='.$isi['id_kandidat'].'" button type="submit" class="btn btn-primary">Reset</button></a> </td>';
...
?>
                  ...
                  <p><strong>NB.Setelah Reset Perolehan Suara Jangan Lupa Reset Daftar Pemilih Juga!!!</strong></p>
                  <ol class="breadcrumb">
