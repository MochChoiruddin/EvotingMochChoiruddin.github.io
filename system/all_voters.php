...
#daftar tr th { font-size:13px !important; text-align: center; padding:5px; }
#daftar tr td { font-size:13px !important; padding:5px; }
.style4 {color: #FFFFFF;
        ...
        <td><table width="100%" border="1" style="border-collapse:collapse" bordercolor="f4f4f4" cellspacing="0" cellpadding="3">
          <tr>
            <td width="79%" align="left" valign="top" bgcolor="#F1F1F1" id="body_form"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
              ...
              <p></p>
              <p>
<div style="background:#999999;padding:10px;" class="style2 style9" align="center"><h3>Data Semua Anggota</h3></div><br />
<table id="daftar" border='1' style="border-collapse:collapse" cellpadding='2' cellspacing='2' align='center' width='100%'>
<tr>
<th>NIP</th>
<th>NAMA</th>
<th>Aksi</th>
...
$tampilkan_isi  = "select  * from students";
...
while  ($isi  = mysql_fetch_array($tampilkan_isi_sql))
	...
	$kelas 		=  $isi['kelas'];
			echo '<tr class="center">';
									echo '<td>'.$isi['matric_no'].'</td>';
									echo '<td><div align="left">'.$isi['password'].'</div></td>';
									
									
									echo '<td><a rel="facebox" href="edit_voter.php?id='.$isi['id'].'">edit</a> </td>';
...
<div id="footer"><span class="col-lg-12">Copyright &copy; SMA Negeri 1 Taman Sidoarjo| Create by Mohammad Choiruddin 2018</span><br />
</div>
<script type="text/javascript">
<!--
