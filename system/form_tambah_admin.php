...
<table class="table table-bordered table-hover"id="daftar" border='1' style="border-collapse:collapse" cellpadding='1' cellspacing='2' align='left' width='85%'>
	...
	<td>User Name</td>
	<td>:</td>
	<td><input type="text" width="200"  name="username" class="ed"></td>
	</tr>
    <tr>
	<td>Password</td>
	<td>:</td>
	<td><input type="text" width="200" height="20" name="password" class="ed"></td>
	</tr>
	...
	<tr>
	  <td></td>
	  <td></td>
	  <td><input type="submit" class="btn btn-primary" value="Tambah" id="button1"> 
	  | 
