...
<head>
    ...
    <script type='text/javascript'>
     ...
     function checkAll(e) {
       var checkboxes = document.getElementsByName('matric_no[]');
...
<h1 class="page-header">
                            Data Siswa Telah Memilih
                      </h1>
<form method="post" action="resetall_after.php">
...
<table class="table table-bordered table-hover"id="daftar" border='1' style="border-collapse:collapse" cellpadding='1' cellspacing='2' align='left' width='85%'>
 <thead>
  <tr>
    <td width="2%" align="left" valign="middle"><input type='checkbox' name='matric_no' onchange="checkAll(this)"></td>
 ...
 <tbody>
  ...
  include "config/dbcon.php";
   ...
   while ($row = mysql_fetch_array($rs)) {
    $id = (int) $row['matric_no'];
    $name = $row['password'];
    $address = $row['kelas'];
  ?>
  <tr>
   <td><input type="checkbox" name="matric_no[]" value="<?php echo $id; ?>"></td>
   <td><?php echo $id; ?></td>
   <td><?php echo $name; ?></td>
...
<button class="btn btn-primary">Reset</button>
                  ...
                  <p>&nbsp;</p>
                  <ol class="breadcrumb">
                    <span class="col-lg-12">Copyright &copy; SMK YPM 3 Taman Sidoarjo| Create by Mohammad Choiruddin 2018</span>
                  </ol>
              </div>
                <!-- /.row -->
