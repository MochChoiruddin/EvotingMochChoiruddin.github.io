...
<div id="header">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="42%" align="left" valign="middle" bgcolor="#FFFFFF"><br />      <img src="../images/hjkk.png" width="442" height="100" /><br /></td>
      <td width="58%" align="right" valign="middle" bgcolor="#FFFFFF"><br />
        ...
        <td width="90%" align="center" valign="middle"><div align="right"><span class="style2"><span class="style3"><?php echo $_SESSION['nama']; ?></span><br />
...
switch($_GET["select"]){
	  	...
	  	case "add_contestant" : include("add_contestant.php"); break;
	  	case "peraturan" : include("peraturan-admin.php"); break;
	  	case "sangsi" : include("sangsi.php"); break;
	  	case "allvoter" : include("allvoter.php"); break;
		case "daftarpemilih-admintambah" : include("add_voters.php"); break;
		case "kategori" : include("post.php"); break;
		case "grafik" : include("diagram.php"); break;
		case "kandidat" : include("add_contestant.php"); break;
		case "kandidat-input-prose" : include("kandidat_admin_input.php"); break;
		case "kandidat-input" : include("kandidat-admin-input.php"); break;
...
?>
            ...
            <td width="21%" align="right" valign="top" bgcolor="#E7EAF0" id="body_form"><table width="100%" border="0" cellspacing="0" cellpadding="2">
              ...
              <tr bgcolor="#999999">
                <td height="29" align="center" valign="middle" id="tabel_head">INFO PEMILIHAN </td>
              </tr>
              <tr>
                <td align="right" valign="top"><ul id="MenuBar2" class="MenuBarVertical">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="left" valign="top" bgcolor="#a43a12"><table width="100%" border="0" cellspacing="0" cellpadding="2">
      <tr bgcolor="#2693FF">
